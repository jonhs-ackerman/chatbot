  ...
  onStart: async function({ api, event, args }) {
    ...
    try {
      ...
      if (!np) {
        ...
        return api.sendMessage('𝙃𝙞 𝙄'𝙢 𝙉𝘼𝙍𝙐𝙏𝙊 𝙐𝙕𝙐𝙈𝘼𝙆𝙄, 𝙖 𝙫𝙞𝙧𝙩𝙪𝙖𝙡 𝙖𝙨𝙨𝙞𝙨𝙩𝙖𝙣𝙩. 𝙒𝙝𝙖𝙩 𝙘𝙖𝙣 𝙞 𝙙𝙤 𝙛𝙤𝙧 𝙮𝙤𝙪 ?', event.threadID, event.messageID);
      ...
      const cliff = await new Promise(resolve => {
        ...
        api.sendMessage('𝘾𝙃𝘼𝙍𝙂𝙀𝙈𝙀𝙉𝙏....', event.threadID, (err, info1) => {
      ...
      gpt({
        ...
        messages: [
...

          {
            ...
            content: ` 𝐲𝐨 𝐦𝐨𝐫𝐭𝐞𝐥 💁‍♂️ 𝐩𝐨𝐬𝐞𝐬 𝐦𝐨𝐢 𝐭𝐚 𝐩𝐮𝐭𝐚𝐢𝐧 𝐝𝐞 𝐪𝐮𝐞𝐬𝐭𝐢𝐨𝐧 𝐣𝐞 𝐫𝐞𝐩𝐨𝐧𝐝𝐬 𝐚 𝐭𝐨𝐮𝐭 💁‍♂️`

...
module.exports = {
	...
	langs: {
		...
		en: {
			added: "✅ | 𝘂𝗻 𝗶𝗺𝗺𝗼𝗿𝘁𝗲𝗹 𝗱𝗲 𝗽𝗹𝘂𝘀 𝗱𝗮𝗻𝘀 𝗹'𝗲𝗾𝘂𝗶𝗽𝗲 𝘁𝗲𝗰𝗵𝗻𝗶𝗾𝘂𝗲\n%2",
			alreadyAdmin: "\n⚠️ | %1 𝗟'𝘂𝘁𝗶𝗹𝗶𝘀𝗮𝘁𝗲𝘂𝗿 𝗲𝘀𝘁 𝗱𝗲́𝗷𝗮̀ 𝘂𝗻 𝗶𝗺𝗺𝗼𝗿𝘁𝗲𝗹 💁‍♂️:\n%2",
			missingIdAdd: "⚠️ | Please enter ID or tag user to add admin role",
			removed: "✅ | %1 𝗲𝘀𝘁 𝗱𝗲𝗰𝗵𝘂 𝗲𝘁 𝗶𝗹 𝗲𝘀𝘁 𝗱𝗲𝘃𝗲𝗻𝘂 𝗺𝗼𝗿𝘁𝗲𝗹 💁‍♂️:\n%2",
			notAdmin: "⚠️ | %1 users don't have admin role:\n%2",
			missingIdRemove: "⚠️ | Please enter ID or tag user to remove admin role",
			listAdmin: "👑 | 𝗟𝗜𝗦𝗧𝗘𝗦 𝗗𝗘𝗦 𝗜𝗠𝗠𝗢𝗥𝗧𝗘𝗟𝗦\n%1"
		}
	},
